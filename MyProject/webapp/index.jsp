...
<div id="header">
	<h1><span class="style1">Student's Bank</span></h1>
    <h2>Skill Developement Institute,Bhubaneswar</h2>
...
<tr >
	<td width="300" valign="top" style="border-right:#666666 1px dotted;">
    	<div id="services"><h1>Services</h1><br>
		    <ul>
        	<li><a href="#">Online Banking Project</a></li>
            <li><a href="#"> Satya sarathi Nayak</a></li>
